...
Usage:
    uv run python text2sql/pipeline.py [--seed 42] [--fail-on-error]
...
def main(argv: list[str] | None = None) -> int:
    ...
    from text2sql.datagen.generate import DATA_DIR, generate
    generate(seed=args.seed)

    logger.info("QUALITY — validating generated CSVs against schema.json")
    from text2sql.quality.reports import write_report
