...
Harvested verbatim from ``src/datagen/reports.py`` (copy, not import — text2sql
is standalone and imports nothing from ``src``). These are pure internal result
objects: stdlib frozen dataclasses, no validation, no scipy, no domain coupling.
"""
